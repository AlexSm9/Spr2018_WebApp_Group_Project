// example js for cookie functionality
// Use functions from this to implement cookies for the chosen page (probably by pasting into another Vue instance).
var app = function() {
    ...
    self.get_cookie = function () {
        ...
        if (result != "") {
            ...
            //here you store your local variables from the fields from obj
            /*
            Examples:
            self.vue.question = obj.question;
            self.vue.UID = obj.UID;
            self.vue.answer = obj.answer;
            //these are interchangeable with any local variable for whatever fields you want to display in the webpage
            */

            //this statement is important, it should determine for the browser in use whether or not an answer has been saved
            //false by default
    ...
    //this is also where you would put your $.post() function(s)
    self.store_cookie = function (ans) {
        ...
        */
        ...
        //now call add_to_cookie for every field that is being written to the object stored in the cookie
        /*
        Examples:
